...
public class Resistances {
	...
	public Resistances(Map<DamageType, Integer> resistances) {
		for(Entry<DamageType, Integer> e : resistances.entrySet()) {
			...
			switch(key) {
				case Fire: this.fireResistance = value; break;
				case Frost: this.frostResistance = value; break;
				case Holy: this.holyResistance = value; break;
				case Shock: this.shockResistance = value; break;
				case Physical: this.physicalResistance = value; break;
				default: System.out.println("DAMAGETYPE OF " + key.toString() + " NO YET IMPLEMENTED!"); break;
			}
		}
	}
